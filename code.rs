...
impl Day for Day4Part2 {
    ...
    fn solve(&self) {
        ...
        // card -> card_id, winning (set of winning numbers), owned (actual numbers you have)
        // win_count -> value of a "card" -> how many matches of winning and owned
        // counts -> dictionary of card ids and their corresponding number of copies (a.k.a number of times it has been won by other cards + 1)
